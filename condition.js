...
//1. define nun1, num2 variables and console.log biggest number
let num1 = 20;
let num2 = 43;
...
//neg huvisagch zarlana, utga ogno tuhain huvisagch dahi utga tegsh esvel sondgoi bolhiig todorhoilson console.log hevleh code bich
let num5 = 6;
if (num5 % 2 == 1) {
  console.log("sondgoi");
} else {
